...
```{r}
#1995 Data: 
  rb <- raster("/Volumes/Zoe's Home/PhD_Program/Projects/tornenvir_climatePopDens/usadens/usads95g/w001001.adf")
...
#2000 Data: 
  rb <- raster(paste0("/Volumes/Zoe's Home/PhD_Program/Projects/tornenvir_climatePopDens", "/gpw-v4-population-density-rev11_2000_2pt5_min_tif/gpw_v4_population_density_rev11_2000_2pt5_min.tif"))
  ext = raster::extent(c(-125, -67, 24, 50))
  PopDens = crop(rb, ext)
...
#2005 Data: 
    rb <- raster(paste0("/Volumes/Zoe's Home/PhD_Program/Projects/tornenvir_climatePopDens", "/gpw-v4-population-density-rev11_2005_2pt5_min_tif/gpw_v4_population_density_rev11_2005_2pt5_min.tif"))
  ext = raster::extent(c(-125, -67, 24, 50))
  PopDens = crop(rb, ext)
...
#2010 Data: 
    rb <- raster(paste0("/Volumes/Zoe's Home/PhD_Program/Projects/tornenvir_climatePopDens", "/gpw-v4-population-density-rev11_2010_2pt5_min_tif/gpw_v4_population_density_rev11_2010_2pt5_min.tif"))
  ext = raster::extent(c(-125, -67, 24, 50))
  PopDens = crop(rb, ext)
...
#2015 Data: 
    rb <- raster(paste0("/Volumes/Zoe's Home/PhD_Program/Projects/tornenvir_climatePopDens", "/gpw-v4-population-density-rev11_2015_2pt5_min_tif/gpw_v4_population_density_rev11_2015_2pt5_min.tif"))
  ext = raster::extent(c(-125, -67, 24, 50))
  PopDens = crop(rb, ext)
...
#2020 Data: 
    rb <- raster(paste0("/Volumes/Zoe's Home/PhD_Program/Projects/tornenvir_climatePopDens", "/gpw-v4-population-density-rev11_2020_2pt5_min_tif/gpw_v4_population_density_rev11_2020_2pt5_min.tif"))
  ext = raster::extent(c(-125, -67, 24, 50))
  PopDens = crop(rb, ext)
  PopDens2015 = projectRaster(PopDens, crs = "+proj=lcc +lat_1=50 +lat_2=50 +lat_0=50 +lon_0=-107 +x_0=0 +y_0=0 +a=6371200 +b=6371200 +units=m +no_defs")
```
