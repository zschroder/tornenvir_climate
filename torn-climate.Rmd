...
Initial Model: 
```{r}
CAPE_m1 <- lm(maxCAPE ~  SSTgradient_15day + avg_Nino3415day + NAO_15day + PNA_15day +  MJO_15day + Lat + Lon, data = BigDays.sfdfT)
summary(CAPE_m1)
...
CAPEpred2 <- c(25, -72, 970)
CAPEpred3 <- c(18, -109, 1513)
...
SLBSpred2 <- c(25, -72, 28.1)
SLBSpred3 <- c(18, -109, 25)
...
DLBSpred1 <- c(10, -92, 20.5)
DLBSpred2 <- c(25, -72, 35.1)
DLBSpred3 <- c(18, -109, 47)
