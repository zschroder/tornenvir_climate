...
Initial Model: 
```{r}
DLBS_m1 <- lm(maxBS_deep ~ SSTgradient_15day + avg_Nino3415day + NAO_15day + PNA_15day +  MJO_15day + Lat + Lon, data = BigDays.sfdfT)
summary(DLBS_m1)
```
...
```
This model explains 57% of the variation of DLBS.
